...
# Run the precompute pdf and csv scripts
echo 'Running precompute pdf and csv scripts...'
python backend/utils/download_vlr_pdfs.py
python backend/utils/pdf_to_csv.py
python backend/utils/process_csv.py
